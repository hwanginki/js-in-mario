(function(n) {
    ...
    function s(t, i, r) {
        var u;
        if (r.indexOf("application/x-javascript") !== -1) return;
...
function(n) {
    n.extend(n.fn, {
        ...
        rules: function(t, i) {
            ...
            return r = n.validator.normalizeRules(n.extend({}, n.validator.metadataRules(r), n.validator.classRules(r), n.validator.attributeRules(r), n.validator.staticRules(r)), r), r.required && (f = r.required, delete r.required, r = n.extend({
                required: f
            }, r)), r
        }
    }), n.extend(n.expr[":"], {
        ...
        prototype: {
            init: function() {
                function i(t) {
                    ...
                    t = "on" + t.type.replace(/^validate/, ""), i.settings[t] && i.settings[t].call(i, this[0])
                }
                var r, t;
            ...
            element: function(t) {
                this.lastElement = t = this.clean(t), this.prepareElement(t), this.currentElements = n(t);
                var i = this.check(t);
            ...
            check: function(t) {
                var f, e, u, i, r;
                t = this.clean(t), this.checkable(t) && (t = this.findByName(t.name).not(this.settings.ignore)[0]), f = n(t).rules(), e = !1;
                for (u in f) {
                    i = {
                        method: u,
                        parameters: f[u]
        ...
        attributeRules: function(t) {
            var i = {},
                u, r;
            t = n(t);
            for (u in n.validator.methods) r = t.attr(u), r && (i[u] = r);
        ...
        methods: {
            ...
            remote: function(t, i, r) {
                ...
                return f = this.previousValue(i), this.settings.messages[i.name] || (this.settings.messages[i.name] = {}), f.originalMessage = this.settings.messages[i.name].remote, this.settings.messages[i.name].remote = f.message, r = typeof r == "string" && {
                    url: r
...
}(jQuery), window.jQuery && function(n) {
    if (n.browser.msie) try {
        document.execCommand("BackgroundImageCache", !1, !0)
    } catch (t) {}
    n.fn.stars = function() {
        return n(this).each(function() {
            n(this).html(n("<span />").width(Math.max(0, Math.min(5, parseFloat(n(this).html()))) * 16))
        })
    }, n.fn.rating = function(t) {
        var i, t;
        return this.length == 0 ? this : typeof arguments[0] == "string" ? this.length > 1 ? (i = arguments, this.each(function() {
            n.fn.rating.apply(n(this), i)
        })) : (n.fn.rating[arguments[0]].apply(this, n.makeArray(arguments).slice(1) || []), this) : (t = n.extend({}, n.fn.rating.options, t || {}), n.fn.rating.calls++, this.not(".star-rating-applied").addClass("star-rating-applied").each(function() {
            var i, f = n(this),
                h = (this.name || "unnamed-rating").replace(/\[|\]/g, "_").replace(/^\_+|\_+$/g, ""),
                o = n(this.form || document.body),
                e = o.data("rating"),
                u, r;
            e && e.call == n.fn.rating.calls || (e = {
                count: 0,
                call: n.fn.rating.calls
            }), u = e[h], u && (i = u.data("rating")), u && i ? i.count++ : (i = n.extend({}, t || {}, (n.metadata ? f.metadata() : n.meta ? f.data() : null) || {}, {
                count: 0,
                stars: [],
                inputs: []
            }), i.serial = e.count++, u = n('<span class="star-rating-control"/>'), f.before(u), u.addClass("rating-to-be-drawn"), (f.attr("disabled") || f.hasClass("disabled")) && (i.readOnly = !0), f.hasClass("required") && (i.required = !0), u.append(i.cancel = n('<div class="rating-cancel"><a title="' + i.cancel + '">' + i.cancelValue + "</a></div>").mouseover(function() {
                n(this).rating("drain"), n(this).addClass("star-rating-hover")
            }).mouseout(function() {
                n(this).rating("draw"), n(this).removeClass("star-rating-hover")
            }).click(function() {
                n(this).rating("select")
            }).data("rating", i))), r = n('<div class="star-rating rater-' + i.serial + '"><a title="' + (this.title || this.value) + '">' + this.value + "</a></div>"), u.append(r), this.id && r.attr("id", this.id), this.className && r.addClass(this.className), i.half && (i.split = 2);
            if (typeof i.split == "number" && i.split > 0) {
                var c = (n.fn.width ? r.width() : 0) || i.starWidth,
                    l = i.count % i.split,
                    s = Math.floor(c / i.split);
                r.width(s).find("a").css({
                    "margin-left": "-" + l * s + "px"
                })
            }
            i.readOnly ? r.addClass("star-rating-readonly") : r.addClass("star-rating-live").mouseover(function() {
                n(this).rating("fill"), n(this).rating("focus")
            }).mouseout(function() {
                n(this).rating("draw"), n(this).rating("blur")
            }).click(function() {
                n(this).rating("select")
            }), this.checked && (i.current = r), this.nodeName == "A" && n(this).hasClass("selected") && (i.current = r), f.hide(), f.change(function() {
                n(this).rating("select")
            }), r.data("rating.input", f.data("rating.star", r)), i.stars[i.stars.length] = r[0], i.inputs[i.inputs.length] = f[0], i.rater = e[h] = u, i.context = o, f.data("rating", i), u.data("rating", i), r.data("rating", i), o.data("rating", e)
        }), n(".rating-to-be-drawn").rating("draw").removeClass("rating-to-be-drawn"), this)
    }, n.extend(n.fn.rating, {
        calls: 0,
        focus: function() {
            var i = this.data("rating"),
                t;
            if (!i) return this;
            if (!i.focus) return this;
            t = n(this).data("rating.input") || n(this.tagName == "INPUT" ? this : null), i.focus && i.focus.apply(t[0], [t.val(), n("a", t.data("rating.star"))[0]])
        },
        blur: function() {
            var i = this.data("rating"),
                t;
            if (!i) return this;
            if (!i.blur) return this;
            t = n(this).data("rating.input") || n(this.tagName == "INPUT" ? this : null), i.blur && i.blur.apply(t[0], [t.val(), n("a", t.data("rating.star"))[0]])
        },
        fill: function() {
            var n = this.data("rating");
            if (!n) return this;
            if (n.readOnly) return;
            this.rating("drain"), this.prevAll().andSelf().filter(".rater-" + n.serial).addClass("star-rating-hover")
        },
        drain: function() {
            var n = this.data("rating");
            if (!n) return this;
            if (n.readOnly) return;
            n.rater.children().filter(".rater-" + n.serial).removeClass("star-rating-on").removeClass("star-rating-hover")
        },
        draw: function() {
            var t = this.data("rating");
            if (!t) return this;
            this.rating("drain"), t.current ? (t.current.data("rating.input").attr("checked", "checked"), t.current.prevAll().andSelf().filter(".rater-" + t.serial).addClass("star-rating-on")) : n(t.inputs).removeAttr("checked"), t.cancel[t.readOnly || t.required ? "hide" : "show"](), this.siblings()[t.readOnly ? "addClass" : "removeClass"]("star-rating-readonly")
        },
        select: function(t, i) {
            ...
            if (typeof t != "undefined") {
                if (typeof t == "number") return n(r.stars[t]).rating("select", undefined, i);
                typeof t == "string" && n.each(r.stars, function() {
                    n(this).data("rating.input").val() == t && n(this).rating("select", undefined, i)
                })
            } else r.current = this[0].tagName == "INPUT" ? this.data("rating.star") : this.is(".rater-" + r.serial) ? this : null;
            this.data("rating", r), this.rating("draw"), u = n(r.current ? r.current.data("rating.input") : null), (i || i == undefined) && r.callback && r.callback.apply(u[0], [u.val(), n("a", r.current)[0]])
        },
        readOnly: function(t, i) {
            var r = this.data("rating");
            if (!r) return this;
            r.readOnly = t || t == undefined ? !0 : !1, i ? n(r.inputs).attr("disabled", "disabled") : n(r.inputs).removeAttr("disabled"), this.data("rating", r), this.rating("draw")
        },
        disable: function() {
        ...
        n("input[type=radio].star").rating()
    })
}(jQuery);
...
(function(n) {
    function i(t) {
        var i = t || window.event,
            ...
            f = 0,
            u = 0;
        return t = n.event.fix(i), t = t.originalEvent, t.type = "mousewheel", i.wheelDelta && (r = i.wheelDelta / 120), i.detail && (r = -i.detail / 3), u = r, i.axis !== undefined && i.axis === i.HORIZONTAL_AXIS && (u = 0, f = -1 * r), i.wheelDeltaY !== undefined && (u = i.wheelDeltaY / 120), i.wheelDeltaX !== undefined && (f = i.wheelDeltaX / -120), e.unshift(t, r, f, u), (n.event.dispatch || n.event.handle).apply(this, e)
    }
    var t = ["DOMMouseScroll", "mousewheel"],
        r;
    if (n.event.fixHooks)
        for (r = t.length; r;) n.event.fixHooks[t[--r]] = n.event.mouseHooks;
    ...
    n.getElementById(i) || (r = n.createElement(t), r.id = i, r.src = "http://platform.twitter.com/widgets.js", u.parentNode.insertBefore(r, u))
}(document, "script", "twitter-wjs"),
function(n, t, i) {
    var r, u = n.getElementsByTagName(t)[0];
    if (n.getElementById(i)) return;
    r = n.createElement(t), r.id = i, r.src = "http://connect.facebook.net/en_US/all.js#xfbml=1", u.parentNode.insertBefore(r, u)
}(document, "script", "facebook-jssdk"),
function() {
    var n = document.createElement("script"),
        t;
    n.type = "text/javascript", n.async = !0, n.src = "https://apis.google.com/js/plusone.js", t = document.getElementsByTagName("script")[0], t.parentNode.insertBefore(n, t)
}()