(function() {
    ...
    var ui = Class.extend({
        ...
        wi = Class.extend({
            init: function(n, t) {
                var f = 0,
                    ...
                    u, i;
                this.onload = t, this.soundNames = ["jump", "coin", "enemy_die", "grow", "hurt", "mushroom", "shell", "shoot", "lifeupgrade"], this.musicNames = ["game", "invincible", "die", "success", "gameover", "peach", "ending",
                    "menu", "editor"
                ], this.musicLoops = [!0, !1, !1, !1, !1, !0, !1, !0, !0], this.count = this.soundNames.length + this.musicNames.length, this.sounds = [], this.tracks = [], this.settings = n || {
                    musicOn: !0
        ...
        ht = rt.extend({
            ...
            load: function(n) {
                var e, o, r, s, u, i, f, t;
                for (this.active && (this.loop && this.pause(), this.reset()), this.setPosition(0, 0),
                    this.setSize(n.width * 32, n.height * 32), this.setImage(n.background), this.raw = n, this.id = n.id, this.active = !0, e = n.data, n.data.splice(n.width), r = 0; r < n.width; r++) {
        ...
        ai = at.extend({
            ...
            move: function() {
                this.active ? (this._super(), this.mode === w.mushroom && this.vx === 0 && this.setVelocity(this.direction === e.right ? -i.mushroom_v : i.mushroom_v, this.vy)) : this.released && (this.released--, this.setPosition(this.x, this.y + 8), this.released || (this.active = !0,
                    this.view.css("z-index", 99), this.mode === w.mushroom && this.setVelocity(i.mushroom_v, i.gravity)))
            },
            hit: function(n) {
        ...
        lf = dt.extend({
            ...
            death: function() {
                return this.deathFramesExtendedActive ? (this.setPosition(this.x, this.y - 8), --this.deathFramesExtended) : (this.view.css({
                    ...
                    this.deathCount += this.deathDir, this.deathCount === this.deathFrames ? this.deathDir = -1 : this.deathCount === 0 && (this.deathFramesExtendedActive = !0),
                    !0)
            }
        }, "pipeplant"),
        et = [{
            ...
            data: [
                ['' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , 'grass_top'],
                ['' , '' , '' , '' , '' , '' , 'mario' , 'pipe_top_left' , 'pipe_left' , 'pipe_left' , 'pipe_left' , 'pipe_left' , 'pipe_left' , 'pipe_left' , 'grass_top'],
                ['' , '' , '' , '' , '' , '' , '' , 'pipe_top_right' , 'pipe_right' , 'pipe_right' , 'pipe_right' , 'pipe_right' , 'pipe_right' , 'pipe_right' , 'grass_top'],
                ['' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , 'grass_top'],
                ['' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , 'grass_top'],
                ['' , '' , '' , '' , '' , '' , 'coin' , 'coin' , '' , '' , '' , 'coin' , 'coin' , '' , 'grass_top'],
                ['' , '' , '' , '' , '' , 'coin' , 'coin' , 'coin' , 'coin' , '' , '' , '' , 'coin' , 'coin' , 'grass_top'],
                ['' , '' , '' , '' , '' , 'coin' , 'coin' , 'coin' , 'coin' , 'coin' , '' , '' , 'coin' , 'coin' , 'grass_top'],
                ['' , '' , '' , '' , '' , 'coin' , 'coin' , '' , '' , 'coin' , 'coin' , '' , 'coin' , 'coin' , 'grass_top'],
                ['' , '' , '' , '' , '' , 'coin' , 'coin' , '' , '' , '' , 'coin' , 'coin' , 'coin' , 'coin' , 'grass_top'],
                ['' , '' , '' , '' , '' , '' , 'coin' , '' , '' , '' , '' , 'coin' , 'coin' , 'coin' , 'grass_top'],
                ['' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , 'grass_top'],
                ['' , '' , '' , '' , '' , 'coin' , 'coin' , '' , '' , '' , '' , '' , 'coin' , 'coin' , 'grass_top'],
                ['' , '' , '' , '' , '' , 'coin' , 'coin' , 'coin' , 'coin' , 'coin' , 'coin' , 'coin' , 'coin' , 'coin' , 'grass_top'],
                ['' , '' , '' , '' , '' , 'coin' , 'coin' , 'coin' , 'coin' , 'coin' , 'coin' , 'coin' , 'coin' , 'coin' , 'grass_top'],
                ['' , '' , '' , '' , '' , 'coin' , 'coin' , '' , '' , '' , '' , '' , 'coin' , 'coin' , 'grass_top'],
                ['' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , 'grass_top'],
                ['' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , '' , 'grass_top'],
          ...
          
        {
            ...
            data: [
                ...
                ["", "", "", "", "", "grass_top", "brown_block", "soil", "soil", "soil", "grass_top_right_rounded_soil", "grass_top",
                    "grass_top_right_rounded_soil", "soil_right", "soil_right"
                ],
                ...
                ["", "", "", "", "", "", "", "", "", "", "grass_top", "soil", "soil", "soil", "grass_top"],
                ["", "", "", "", "", "", "", "", "", "", "grass_top_right_rounded", "soil_right",
                    "soil_right", "soil_right", "grass_top"
                ],
                ["", "", "", "", "", "", "", "", "", "", "", "", "", "", "grass_top"],
                ["", "", "", "", "", "", "", "", "", "", "", "", "", "ballmonster", "grass_top"],
                ["", "", "", "", "", "", "", "", "", "", "", "", "", "bush_left", "grass_top"],
                ...
                ["", "", "", "", "", "", "", "bush_middle_left", "grass_top", "planted_soil_right", "grass_top_right_rounded_soil",
                    "grass_top_left_rounded_soil", "soil_left", "soil_left", "soil_left"
                ],
            ...
            data: [
                ...
                ["", "", "", "", "", "", "stone", "", "", "", "", "", "", "", ""],
                ["", "", "", "", "", "grass_top_left_rounded", "soil_left", "soil_left",
                    "soil_left", "soil_left", "soil_left", "soil_left", "soil_left", "soil_left", "soil_left"
                ],
    ...
    var bi = ht.extend({
        ...
        t = {
            ...
            section: function(n, i) {
                ...
                t.current = n, location.hash !== "#" + n && (location.hash = n),
                    (arguments.length < 2 || !i) && d && d.music(n), $(".layer").hide(), n === "menu" ? y.start() : y.stop(), $(".section:visible").hide("slide", {
                        direction: "left"
                    }, 400), $("#" + n).show("slide", {
                        direction: "right"
            ...
            level: function(n, i) {
                t.section("levelloading", !0),
                    ot.custom = !1, ot.editor = !1, f.load(et[n]), i && f.importSaveGame(i), f.setDeadCallback(t.end), f.setNextCallback(t.next), f.setSameCallback(t.same), t.showGame()
            },
            custom: function(n, i) {
                t.section("levelloading", !0), ot.custom = !0,
                    ot.editor = i, f.load(n), i ? (f.importSaveGame({
                        lifes: 0,
                        coins: 0,
                        state: h.small,
                        marioState: a.normal
            ...
            handlers: function() {
                ni.onend = function() {
                    ...
                    $("#controlsButton1").click(function() {
                        t.layer("controls1")
                    }),
